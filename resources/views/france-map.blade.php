...
<body>
    ...
    <div class="page-wrapper">
        ...
        <header class="page-header">
            ...
            {{-- Lien vers le back-office de gestion des agents --}}
            <div class="mt-4">
                <a href="{{ route('admin') }}" class="admin-link">
                    {{-- Icône engrenage (SVG inline) --}}
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0
                               ...
                               1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0
