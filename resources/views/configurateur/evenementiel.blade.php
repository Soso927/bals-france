            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div id="section-s2" class="p-6 flex flex-col gap-7">
                        ...
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-3">Type de coffret <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-3">Matériaux <span class="text-red-500">*</span></label>
                            <div class="grid grid-cols-3 gap-3">
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" name="materiau" value="Flight-cases" class="sr-only peer" onchange="mettreAJour()">
                                    <div class="border-2 border-gray-200 rounded-xl p-3 text-center transition-all peer-checked:border-bals-blue peer-checked:bg-blue-50 hover:border-bals-blue cursor-pointer">
                        ...
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-3">Indice de Protection (IP) <span class="text-red-500">*</span></label>
                            <div class="grid grid-cols-3 gap-3">
                                <label class="cursor-pointer">
                                                ...
                                                <td class="px-5 py-4 border-r border-gray-100">
                                                    <div class="flex items-center justify-center gap-2">
                                                        ...
                                                        <span class="w-10 text-center font-bold text-gray-800 text-sm"
                                                            data-alim="{{ $alim }}" data-brochage="{{ $brochage }}">0</span>
                                                        <button type="button" onclick="changerQteAlim(this, 1)"
                                                            class="w-8 h-8 rounded-lg border border-gray-300 text-gray-600 hover:bg-gray-100 text-sm font-bold">+</button>
                                                    </div>
                                                </td>
                ...
                {{-- SECTION 04 : CARACTÉRISTIQUES DES PRISES --}}
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="bg-bals-blue text-white px-6 py-4 flex items-center justify-between cursor-pointer"
                                            ...
                                            <td class="px-5 py-4 border-r border-gray-100">
                                                <div class="flex items-center justify-center gap-2">
                                                    <button type="button" onclick="changerQte(this, -1)"
                                                        class="w-8 h-8 rounded-lg border border-gray-300 text-gray-600 hover:bg-gray-100 text-sm font-bold">−</button>
                                                    <span class="w-10 text-center font-bold text-gray-800 text-sm"
                                                        data-type="CEI TBT" data-brochage="{{ $brochage }}">0</span>
                                                    <button type="button" onclick="changerQte(this, 1)"
                                                        class="w-8 h-8 rounded-lg border border-gray-300 text-gray-600 hover:bg-gray-100 text-sm font-bold">+</button>
                                                </div>
                                            </td>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div id="section-s4" class="hidden p-6">
                        <p class="text-xs text-gray-400 mb-4 italic">La protection de tête protège l'ensemble du coffret événementiel.</p>
                        <div class="grid grid-cols-2 gap-3">
                            @foreach (['Sans', 'Interrupteur', 'Inter différentiel', 'Disjoncteur', 'Disjoncteur Diff.'] as $opt)
                                <label class="cursor-pointer">
                                    <input type="checkbox" name="prot_tete[]" value="{{ $opt }}" class="peer sr-only" onchange="mettreAJour()">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div id="section-s5" class="hidden p-6">
                        <p class="text-xs text-gray-400 mb-4 italic">Configuration de la protection individuelle ou par groupe pour l'événementiel.</p>
                        <div class="grid grid-cols-2 gap-3">
                            <label class="cursor-pointer">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div id="section-s6" class="hidden p-6">
                        <p class="text-xs text-gray-400 mb-4 italic">Spécifications particulières pour votre événement (type d'événement, durée, conditions particulières...).</p>
