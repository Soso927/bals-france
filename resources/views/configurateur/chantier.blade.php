    ...
    <div class="flex-1 flex flex-col gap-5">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div class="flex flex-wrap gap-3" id="type-coffret-buttons">
                ...
                {{-- Boutons inactifs --}}
                <button class="btn-type px-5 py-2.5 rounded-xl font-bold text-sm border-2 border-gray-200 text-gray-600 hover:border-bals-blue hover:text-bals-blue transition-all"
