...
function mettreAJour() {
    ...
    const tension = document.querySelector('select[name="tension"]').value;
    const polarite = document.querySelector('select[name="polarite"]').value;
    const raccordement = document.querySelector('select[name="raccordement"]').value;
    ...
    if (tension || polarite || raccordement) {
        html += '<div class="border-t border-gray-100 pt-2 space-y-1">';
        html += '<p class="text-xs text-gray-400 font-bold mb-1">Alimentation :</p>';
        if (tension) html += '<p class="text-xs"><span class="text-gray-400">Tension :</span> <span class="font-bold text-gray-700">' + tension + '</span></p>';
        if (polarite) html += '<p class="text-xs"><span class="text-gray-400">Polarité :</span> <span class="font-bold text-gray-700">' + polarite + '</span></p>';
        if (raccordement) html += '<p class="text-xs"><span class="text-gray-400">Raccordement :</span> <span class="font-bold text-gray-700">' + raccordement + '</span></p>';
        html += '</div>';
    }
